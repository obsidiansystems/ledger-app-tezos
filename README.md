...
Then return to this document and continue reading at *Using the Ledger Applications*.
...
```
Found a Tezos Wallet 1.4.0 (commit 764625b1) application running on Ledger device at [0001:002a:00].
